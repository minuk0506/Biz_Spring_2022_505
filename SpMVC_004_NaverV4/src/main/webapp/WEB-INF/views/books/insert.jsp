...
<form method="POST" class="w3-container">
	...
	<div>
		...
		<input name="price" class="w3-input" placeholder="가격" type="number"
			value="${BOOK.price}">
	</div>
	<div>
		<input name="discount" class="w3-input" placeholder="할인" value="${BOOK.discount}">
	...
	<textarea name="description" class="w3-input" rows="10">${BOOK.description}</textarea>
