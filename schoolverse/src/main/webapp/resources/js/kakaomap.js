document.addEventListener("DOMContentLoaded", () => {
  ...
  var mapOptions = {
    //지도를 생성할 때 필요한 기본 옵션
    center: new kakao.maps.LatLng(35.16004904555226, 126.91010873348127), //지도의 중심좌표.
    ...
    function (result, status) {
      ...
      if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
          content:
            '<div style="width:150px;text-align:center;padding:6px 0;">한국경영원</div>',
        });
