  ...
  <section class="section">
    ...
    <form class="search-bar" method="POST">
      ...
      <div class="search-detail">
        <select class="select-main" name="space">
      ...
      <div class="search-detail">
        <select class="select-main" name="subject">
      ...
      <div class="search-wall"></div>
      <div class="search-detail">
        <select class="select-main" name="age">
      ...
      <div class="search-wall"></div>
      <div class="search-detail">
        <select class="select-main" name="cost">
      ...
      <div class="search-wall"></div>
            <div class="search-detail">
      <input class="select-main" type="text" placeholder="학원명을 입력해주세요" name="search"/>
      </div>
      <div class="search-wall"></div>
