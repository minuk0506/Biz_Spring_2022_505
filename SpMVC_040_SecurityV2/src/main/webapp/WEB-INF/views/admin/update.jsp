...
<div class="w3-container w3-card-4">
	...
	<label class="w3-text-blue">USERNAME</label>
		<input class="w3-input w3-border" readonly="readonly" value='${USER.username}'>
	<label class="w3-text-blue">EMAIL</label>
		<input name="email" class="w3-input w3-border" value='${USER.email}'>
	<label class="w3-text-blue">실명</label>
		<input name="realname" class="w3-input w3-border" value='${USER.realname}'>
	<label class="w3-text-blue">닉네임</label>
		<input name="nickname" class="w3-input w3-border" value='${USER.nickname}'>
	<label class="w3-text-blue">전화번호</label>
		<input name="tel" class="w3-input w3-border" value='${USER.tel}'>
