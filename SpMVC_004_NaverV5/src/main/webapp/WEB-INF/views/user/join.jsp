...
<script src="${rootPath}/static/js/join.js?20220609009"></script><!-- ?ver=2022-06-09-001 같이 안하고 이렇게 해도됨 -->
</head>
...
<body>
	<form method=POST class="w3-container w3-card-4 join">
		...
		<input name="repassword" id=re_password placeholder="RE_PASSWORD" class="w3-input w3-border">
		...
		<button class="w3-button w3-blue" id="btn_join" type="button">회원가입</button>
	</form>
</body>
</html>