...
<script src="${rootPath}/static/js/input.js?ver=2022-06-08-013"></script>
</head>
<body>
	<header>
		<h1>My API</h1>
	...
	<nav>
		<ul>
			...
			<c:if test="${not empty USER}">
				<li><a href="${rootPath}/user/mypage">마이페이지(${USER.nickname})</a></li>
