...
public class StudentController {
	 ...
	 * 
	 * 위 아래 input() 가 같은 역할을 수행하는 method 이다
	 * 위 method 는 StudentVO에 변수가 다 있다
	 * 
...
//		int index = 0;
//		for(index = 0 ; index < stNums.length ; index ++) {
//			if(stNums[index].equals(st_num)) break;
//		}
//		// if() 조건문에 의해 실행될 명령문이 1라인 일경우
//		// {} 는 생략 가능
//		if(index < stNums.length) return "USE";
//		return "NOT";
	}
}
